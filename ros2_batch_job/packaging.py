...
def build_and_test_and_package(args, job, colcon_script):
    ...
    if args.os == 'linux':
        ...
        with zipfile.ZipFile(archive_path, 'w') as zf:
            ...
            zf.write(r"C:\pixi_ws\pixi.lock", arcname=os.path.join(folder_name, "pixi.lock"))
            zf.write(r"C:\pixi_ws\pixi.toml",  arcname=os.path.join(folder_name, "pixi.toml"))
            zf.write(r"C:\ci\preinstall_setup_windows.py", arcname=os.path.join(folder_name, "preinstall_setup_windows.py"))
